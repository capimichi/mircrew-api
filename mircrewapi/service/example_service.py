...
from mircrewapi.client.example_client import ExampleClient
...
class ExampleService:
    ...
    def get_example(self, title: str | None = None, message: str | None = None) -> dict:
        ...
        return {"title": resolved_title, "message": resolved_message}
